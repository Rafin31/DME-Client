...
const AllRepairOrder = () => {
    ...
    if (orders !== "No order found!") {
        allRepairOrder = orders
        newReferralEmptyRows = page > 0 ? Math.max(0, (1 + page) * rowsPerPage - allRepairOrder.length) : 0;
        filteredNewReferralOrders = applySortFilter(allRepairOrder, getComparator(order, orderBy), filterName);
                    ...
                    <TableContainer sx={{ minWidth: 800 }}>
                        <Table size="small">
                            ...
                            <UserListHead
                                ...
                                rowCount={allRepairOrder.length}
