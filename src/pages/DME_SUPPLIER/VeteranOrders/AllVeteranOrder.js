...
const AllVeteranOrder = () => {
    ...
    if (orders !== "No order found!") {
        allVeteranOrder = orders
        cancelledEmptyRows = page > 0 ? Math.max(0, (1 + page) * rowsPerPage - allVeteranOrder.length) : 0;
        filteredCancelledOrders = applySortFilter(allVeteranOrder, getComparator(order, orderBy), filterName);
                    ...
                    <TableContainer sx={{ minWidth: 800 }}>
                        <Table size="small">
                            ...
                            <UserListHead
                                ...
                                rowCount={allVeteranOrder.length}
...
export default AllVeteranOrder;