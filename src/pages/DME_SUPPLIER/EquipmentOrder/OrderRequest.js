...
const OrderRequest = () => {
    ...
    let OrderRequestOrders
    let orderRequestEmptyRows
    let filteredOrderRequestOrders
    let OrderRequestIsNotFound
    let row
    ...
    if (orders !== "No order found!") {
        ...
        row = filteredOrderRequestOrders.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
    }
        ...
        <>
            ...
            <Card style={{ margin: "20px 0px" }}>
                    ...
                    <TableContainer sx={{ minWidth: 800 }}>
                        <Table size="small">
                            ...
                            <UserListHead
                                ...
                                rowCount={OrderRequestOrders.length}
                            ...
                            <TableBody>
                                ...
                                {orderRequestEmptyRows > 0 || (
                                    <TableRow style={{ height: 53 * orderRequestEmptyRows }}>
                                        <TableCell colSpan={6} />
                                    </TableRow>
                                )}
                ...
                <TablePagination
                    ...
                    component="div"
                    count={OrderRequestOrders.length}
